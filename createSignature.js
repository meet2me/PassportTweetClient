...
module.exports = {
 create : function(method,urlString,params,oauth_headers,consumerSecret,access_token_secret,oauth_token_secret){
 ...
 if(access_token_secret!=null){
  ...
  reqString = method + '&'+ randomGeneration.encodeData(urlString) + '&' + randomGeneration.encodeData((params).join('&')) + randomGeneration.encodeData(oauth_headers.join('&'));
  key = randomGeneration.encodeData(consumerSecret) + '&' + randomGeneration.encodeData(oauth_token_secret);
